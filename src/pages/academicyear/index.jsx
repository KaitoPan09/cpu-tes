import { Box, Typography, useTheme, Button, DialogContent } from "@mui/material";
                ...
                return(
                    <Box
                        ...
                        >
                            ...
                            <Typography
                                colors={colors.grey[100]} sx={{ml: "5px"}}>
                                {status}
                            </Typography>
                    </Box>
                )
                        ...
                        {selectedRowData && (
                            <Box>
                                <Box>
                                    ...
                                    <input
                                        type="text"
                                        value={selectedRowData.academicYear}
                                        />
                                </Box>
                                <Box>
                                    ...
                                    <input
                                        type="text"
                                        value={selectedRowData.semester}
                                        />
                                </Box>
                            </Box>
                        )}
